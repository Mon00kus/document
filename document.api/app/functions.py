...
def get_s3_client():
    """
    Crea y retorna un cliente de S3 (compatible con MinIO/LocalStack)
    """
    return boto3.client(
        "s3",
...
async def upload_file_to_s3(
    file_content: bytes, filename: str, bucket: str = None
) -> str:
    """
    ...
    try:
        ...
        s3_client.put_object(Bucket=bucket, Key=s3_key, Body=file_content)
